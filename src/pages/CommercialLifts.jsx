...
const CommercialLifts = () => {
  ...
  return (
    <div className="commercial-page bg-dark min-vh-100">
      {/* Hero Section */}
      <section className="about-hero-section position-relative pt-5 overflow-hidden d-flex align-items-center" style={{ minHeight: '600px' }}>
        ...
        <div className="container position-relative py-5" style={{ zIndex: 5 }}>
          <div className="row align-items-center">
            <div className="col-lg-8" data-aos="fade-right">
              <h6 className="text-primary text-uppercase tracking-widest fw-800 mb-3 small">Advanced Infrastructure</h6>
              <h1 className="huge-contact-title mb-4">
                COMMERCIAL <span className="text-primary">LIFTS</span>
              </h1>
              <p className="text-white-50 lead mb-5 max-w-600">
                Tailored vertical mobility solutions for modern business environments, from high-speed passenger transits to heavy-duty logistical elevators.
              </p>
        ...
        <div className="about-hero-image-overlay d-none d-lg-block" data-aos="fade-left">
          <img src={heroImg} alt="Commercial Lifts" className="hero-clip-img" />
        </div>
      ...
      <section id="explore" className="py-5 mt-5">
        <div className="container">
          <div className="text-center mb-5" data-aos="fade-up">
            <h6 className="text-primary text-uppercase tracking-widest fw-800 mb-3 small">Our Expertise</h6>
            <h2 className="display-4 fw-900 text-white">Commercial <span className="text-primary">Verticality</span></h2>
          </div>
      ...
      <section className="py-5 bg-dark-lighter">
        <div className="container py-5">
          <div className="row g-4 text-center">
             {[
               { icon: <Shield className="text-primary" size={32}/>, title: "High Safety", desc: "Redundant safety systems and AI monitoring." },
               { icon: <Clock className="text-primary" size={32}/>, title: "24/7 Support", desc: "Dedicated commercial maintenance team." },
               { icon: <Users className="text-primary" size={32}/>, title: "Traffic Control", desc: "Intelligent destination dispatch systems." }
             ].map((f, i) => (
      ...
      <style>{`
        .commercial-page { background: #000000; }
