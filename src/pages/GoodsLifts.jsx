  ...
  const liftModels = [
    {
      ...
      desc: "Designed for safe transportation of goods across multiple floors. Ideal for restaurants, hotels, and hospitals where space-saving performance is key.",
      specs: [
    ...
    },
    {
      ...
      desc: "Perfect for warehouses and factories, combining strength and precision. Built to handle loads up to 2000 kg with absolute ease and safety.",
      specs: [
        { label: "Travel Height", value: "Up to 30m (G+10)" },
    ...
    <div className="product-page bg-dark min-vh-100 pb-5">
      ...
      <section className="about-hero-section position-relative pt-5 overflow-hidden mb-5 d-flex align-items-center" style={{ minHeight: '600px' }}>
        ...
        <div className="container position-relative py-5" style={{ zIndex: 5 }}>
          <div className="row align-items-center min-vh-50">
            <div className="col-lg-7 d-flex flex-column justify-content-center" data-aos="fade-right">
              <h6 className="text-primary text-uppercase tracking-widest fw-800 mb-3 small">Industrial Logistics Solutions</h6>
              <h1 className="huge-contact-title mb-4">
                GOODS <span className="text-primary">LIFTS</span>
              </h1>
              <p className="text-white-50 lead mb-5 max-w-400">
                Robust, reliable, and high-capacity vertical transport solutions for efficient goods movement in commercial and industrial spaces.
              </p>
        ...
        <div className="about-hero-image-overlay d-none d-lg-block" data-aos="fade-left">
          <img src={heroImg} alt="Goods Lifts" className="hero-clip-img" />
        </div>
      ...
      <section className="technical-features py-5 bg-dark-lighter mt-5">
        <div className="container py-5">
          <div className="text-center mb-5" data-aos="fade-up">
            ...
            <h2 className="display-5 fw-900 text-white mb-5">Built for <span className="text-primary">Durability</span></h2>
          </div>
          <div className="row g-4">
            {[
              { title: "Heavy Capacity", desc: "Reinforced structures to handle up to 2000kg of cargo daily.", icon: <Package size={30} /> },
              { title: "Impact Resistant", desc: "Durable MS or SS finishes built to withstand industrial wear and tear.", icon: <Hammer size={30} /> },
              { title: "Smooth Loading", desc: "Flush floor leveling for easy movement of trolleys and pallets.", icon: <Truck size={30} /> },
              { title: "Safe Operation", desc: "Integrated safety locks and overload sensors for material protection.", icon: <Shield size={30} /> }
            ].map((feature, i) => (
        ...
        <div className="container">
          <div className="glass-card-dark p-5 text-center overflow-hidden position-relative" data-aos="zoom-in">
            <div className="position-relative z-10">
              <h2 className="display-5 fw-800 text-white mb-4">Strength You Can Depend On</h2>
              <p className="text-white-50 mb-5 max-w-600 mx-auto">
                Consult with our industrial experts for the right goods transport solution for your facility.
              </p>
