...
const ResidentialLiftsHub = () => {
  ...
  return (
    <div className="residential-hub bg-dark min-vh-100">
      {/* Hero Section */}
      <section className="about-hero-section position-relative pt-5 overflow-hidden d-flex align-items-center" style={{ minHeight: '600px' }}>
        ...
        <div className="container position-relative py-5" style={{ zIndex: 5 }}>
          <div className="row align-items-center">
            <div className="col-lg-8" data-aos="fade-right">
              <h6 className="text-primary text-uppercase tracking-widest fw-800 mb-3 small">Domestic Mobility</h6>
              <h1 className="huge-contact-title mb-4">
                RESIDENTIAL <span className="text-primary">LIFTS</span>
              </h1>
              <p className="text-white-50 lead mb-5 max-w-600">
                Elevating the comfort and value of your home with silent, safe, and sophisticated vertical mobility solutions.
              </p>
        ...
        <div className="about-hero-image-overlay d-none d-lg-block" data-aos="fade-left">
          <img src={heroImg} alt="Residential Lifts" className="hero-clip-img" />
        </div>
      ...
      <section id="explore" className="py-5 mt-5">
        <div className="container">
          <div className="text-center mb-5" data-aos="fade-up">
            <h6 className="text-primary text-uppercase tracking-widest fw-800 mb-3 small">Tailored for Living</h6>
            <h2 className="display-4 fw-900 text-white">Vertical <span className="text-primary">Home Solutions</span></h2>
          </div>
      ...
      <section className="py-5 bg-dark-lighter">
        <div className="container py-5">
          <div className="row g-4 text-center">
             {[
               { icon: <Shield className="text-primary" size={32}/>, title: "Family Safety", desc: "Advanced sensors and automatic rescue devices." },
               { icon: <Heart className="text-primary" size={32}/>, title: "Smooth Ride", desc: "Jerk-free motion optimized for elderly comfort." },
               { icon: <Zap className="text-primary" size={32}/>, title: "Low Energy", desc: "Energy-efficient single-phase power options." }
             ].map((f, i) => (
      ...
      <style>{`
        .residential-hub { background: #000000; }
...
export default ResidentialLiftsHub;
