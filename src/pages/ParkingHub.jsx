...
const ParkingHub = () => {
  const categories = [
    {
      title: "Car Parking Lifts",
      path: "/lifts/parking/car",
      desc: "Smart vertical parking solutions to maximize space in commercial and residential properties.",
      icon: <Car size={40} />,
  ...
  return (
    <div className="parking-hub bg-dark min-vh-100">
      {/* Hero Section */}
          ...
          <div className="row align-items-center">
            <div className="col-lg-8" data-aos="fade-right">
              ...
              <p className="text-white-50 lead mb-5 max-w-600">
                Transforming urban spaces with automated, stackable, and high-security vertical parking systems.
              </p>
              <div className="d-flex gap-3">
                <a href="#explore" className="btn-premium px-5 py-3 text-decoration-none">Explore Parking</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="explore" className="py-5 mt-5">
        <div className="container">
          <div className="text-center mb-5" data-aos="fade-up">
            <h6 className="text-primary text-uppercase tracking-widest fw-800 mb-3 small">Vertical Parking</h6>
            <h2 className="display-4 fw-900 text-white">Smart <span className="text-primary">Storage</span></h2>
          </div>
      ...
      <section className="py-5 bg-dark-lighter">
        <div className="container py-5">
          <div className="row g-4 text-center">
             {[
               { icon: <Smartphone className="text-primary" size={32}/>, title: "Smart Control", desc: "Automated retrieval systems with mobile integration." },
               { icon: <Shield className="text-primary" size={32}/>, title: "Secure Transit", desc: "Anti-fall mechanisms and vehicle stability locks." },
               { icon: <Layout className="text-primary" size={32}/>, title: "Density Max", desc: "Double or triple your parking capacity effortlessly." }
             ].map((f, i) => (
