            ...
            <div data-aos="fade-up" className="container">
              ...
              <div className="d-flex justify-content-center flex-wrap gap-3 mb-5">
                <button 
                  ...
                  style={{ borderRadius: '4px', backgroundColor: '#D4AF37', color: '#0F172A', border: 'none' }}
                >
                ...
                <button 
                  ...
                  style={{ borderRadius: '4px', backgroundColor: 'transparent', color: '#FFFFFF', borderColor: '#FFFFFF' }}
                >
                  View Projects
                </button>
              </div>
